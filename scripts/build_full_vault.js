...
const itineraryData = [
  ...
  },
  {
    date: "9/19",
    weekday: "六",
    title: "🏛️ 歐洲遺產日：09:00 退房換單 ➔ 10:30 巴黎市政廳內部參觀 ➔ 瑪黑漫步 ➔ 拍婚紗前夜準備",
    tag: "歐洲遺產日",
    summary: "09:00 辦理退房換單手續確認續住！歐洲遺產日限定開放：10:30 參觀巴黎市政廳內部金碧輝煌節慶大廳與市長辦公室（已獲邀請函），午後瑪黑漫步，傍晚清點整理婚紗配件與 €2500 現金，21:00 早睡迎接明日開拍！",
    keynote: {
      code: "10:30 入場 (T3508E / T3509E)",
      codeLabel: "市政廳預約邀請函",
      spot: "B&B飯店櫃檯 ➔ 巴黎市政廳 ➔ 瑪黑商圈",
    ...
    items: [
      {
        time: "09:00",
        title: "B&B飯店櫃檯辦理退房續住 (換單手續) ＆ 輕裝出發",
        desc: "第 1 段住宿 (BB22425685) 今日退房，接續第 2 段住宿 (BB22425273，9/19-9/21)。至 1 樓櫃檯出示新訂單確認原房續住免搬遷（若需清潔則暫寄行李於櫃檯），隨身攜帶證件輕裝出發前往市政廳！",
        badges: ["退房換單手續", "同房續住免搬遷", "新單BB22425273", "輕裝出發"],
        map: "B&B HOTEL Paris Italie Porte de Choisy"
      },
      {
        time: "10:15",
  ...
  },
  {
    date: "9/25",
    weekday: "五",
    title: "退房搭計程車 ➔ 蒙帕納斯TGV ➔ 雷恩取車 ➔ 聖馬洛 ➔ 聖米山 Mercure",
    tag: "自駕起跑",
    summary: "婚紗已於 9/21 歸還！清晨 05:35 飯店門口搭乘計程車直達蒙帕納斯高鐵站 2 樓出發大廳，06:48 搭乘 TGV 高鐵直奔雷恩領車，走訪聖馬洛海盜城與康卡勒生蠔，入住聖米山管制區 Mercure！",
    keynote: {
      code: "TGV: 4WCP2R / 車庫碼: 6060",
      codeLabel: "TGV 代號 ＆ 取車密碼",
      spot: "B&B飯店 ➔ 計程車 ➔ 蒙帕納斯高鐵站 ➔ 雷恩 ➔ 聖馬洛 ➔ 聖米山",
    ...
    items: [
      {
        time: "05:35",
        title: "B&B 退房 ＆ 飯店門口搭乘計程車 (Uber/G7) 直奔蒙帕納斯車站",
        desc: "05:00 起床梳洗，婚紗已於 9/21 順利歸還一身輕！05:30 櫃檯辦理退房推 2 件大行李至門口。05:35 預約之計程車準時抵達，司機協助置放行李。清晨直行南環道無塞車約 12-15 分鐘（車資約 18€），直接送達蒙帕納斯車站 (Gare Montparnasse) 2 樓出發大廳落客區，免扛行李爬地鐵階梯！",
        badges: ["婚紗已於9/21歸還", "05:35計程車直達", "車程約15分免搬重物", "直達2樓出發大廳"],
        map: "Gare Montparnasse Paris"
      },
      {
        time: "05:55",
        title: "抵達蒙帕納斯高鐵站 2 樓大廳・買熱咖啡可頌 ＆ 看大螢幕月台",
        desc: "下車即在 Hall 1（2樓出發大廳）。走進大廳中央仰望大型電子螢幕 (Affichage Départs)。發車前 20 分鐘 (約 06:28) 螢幕會顯示 TGV INOUI 8605 班次的月台編號 (Voie 1~24)。可在大廳 PAUL 麵包店買杯熱拿鐵與新鮮現烤可頌當早餐。",
        badges: ["看大螢幕查月台Voie", "發車前20分顯示", "買熱咖啡可頌"],
        map: "Gare Montparnasse Paris"
      },
      {
        time: "06:48",
        title: "巴黎 Montparnasse 搭乘 SNCF TGV 高鐵前往雷恩 (Rennes)",
        desc: "掃描車票 QR Code 進站（訂位代號: 4WCP2R，TGV INOUI 8605，2人共 68€）。依車廂號碼 (Voiture) 依序上車，將 2 件大行李放入車廂入口處專用大型行李架。06:48 準時發車，車程約 1.5 小時，08:15 準點抵達布列塔尼首府雷恩高鐵站。",
        badges: ["TGV高鐵 4WCP2R", "車程1.5小時", "巴黎➔雷恩", "08:15抵達雷恩"],
        map: "Gare Montparnasse Paris"
      },
      {
        time: "08:30",
